...
//! <b> Toy bulk viscous model, step function. </b>
/*!
      One dimensional test
*/
class BlobToyPi : public InitialFunc
{
  public:
    /*! Constructor
      @param[in] *data Pointer to Data class containing global simulation data
...
*/
class Blob2dToyPi : public InitialFunc
{
  public:
    /*! Constructor
      @param[in] *data Pointer to Data class containing global simulation data
      @sa InitialFunc
    */
    Blob2dToyPi(Data * data);

    virtual ~Blob2dToyPi() { }     //!< Destructor
};
...
/*!
      Two dimensional test
*/
class Blob3dToyPi : public InitialFunc
{
  public:
    /*! Constructor
      @param[in] *data Pointer to Data class containing global simulation data
      @sa InitialFunc
    */
    Blob3dToyPi(Data * data);

    virtual ~Blob3dToyPi() { }     //!< Destructor
};
