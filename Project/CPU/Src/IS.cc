  ...
  for (int i(0); i < d->Nx; i++) {
    for (int j(0); j < d->Ny; j++) {
      for (int k(0); k < d->Nz; k++) {
        ...
        prims[ID(Prims::dpdt, i, j, k)]  = aux[ID(Aux::dtp, i, j, k)];
        prims[ID(Prims::drhodt, i, j, k)]  = aux[ID(Aux::dtrho, i, j, k)];
        prims[ID(Prims::dv1dt, i, j, k)]  = aux[ID(Aux::dtv1, i, j, k)];
        prims[ID(Prims::dv2dt, i, j, k)]  = aux[ID(Aux::dtv2, i, j, k)];
        prims[ID(Prims::dv3dt, i, j, k)]  = aux[ID(Aux::dtv3, i, j, k)];
