  ...
  for (int i(0); i < data->Nx; i++) {
    for (int j(0); j < data->Ny; j++) {
      for (int k(0); k < data->Nz; k++) {
        ...
        icons[ID(Cons::S1, i, j, k)] = dcons[ID(Cons::S1, i, j, k)] - (daux[ID(Aux::Pi, i, j, k)] + daux[ID(Aux::A, i, j, k)])*dprims[ID(Prims::v1, i, j, k)]*daux[ID(Aux::W, i, j, k)]*daux[ID(Aux::W, i, j, k)] 
                              - (daux[ID(Aux::q1, i, j, k)] + daux[ID(Aux::qv, i, j, k)]*dprims[ID(Prims::v1, i, j, k)])*daux[ID(Aux::W, i, j, k)] - dprims[ID(Aux::pi01, i, j, k)];
        icons[ID(Cons::S2, i, j, k)] = dcons[ID(Cons::S2, i, j, k)] - (daux[ID(Aux::Pi, i, j, k)] + daux[ID(Aux::A, i, j, k)])*dprims[ID(Prims::v2, i, j, k)]*daux[ID(Aux::W, i, j, k)]*daux[ID(Aux::W, i, j, k)]
                              - (daux[ID(Aux::q2, i, j, k)] + daux[ID(Aux::qv, i, j, k)]*dprims[ID(Prims::v2, i, j, k)])*daux[ID(Aux::W, i, j, k)] - dprims[ID(Aux::pi02, i, j, k)];
        icons[ID(Cons::S3, i, j, k)] = dcons[ID(Cons::S3, i, j, k)] - (daux[ID(Aux::Pi, i, j, k)] + daux[ID(Aux::A, i, j, k)])*dprims[ID(Prims::v3, i, j, k)]*daux[ID(Aux::W, i, j, k)]*daux[ID(Aux::W, i, j, k)]
                              - (daux[ID(Aux::q3, i, j, k)] + daux[ID(Aux::qv, i, j, k)]*dprims[ID(Prims::v3, i, j, k)])*daux[ID(Aux::W, i, j, k)] - dprims[ID(Aux::pi03, i, j, k)];                                                            
        icons[ID(Cons::Tau, i, j, k)] = dcons[ID(Cons::Tau, i, j, k)] - (daux[ID(Aux::Pi, i, j, k)] + daux[ID(Aux::A, i, j, k)])*(daux[ID(Aux::W, i, j, k)]*daux[ID(Aux::W, i, j, k)] - 1) 
