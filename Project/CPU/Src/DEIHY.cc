...
// Dissipative Extension for Ideal Hydrodynamics
DEIHY::DEIHY()
{
  sourceExists = true;
}

DEIHY::DEIHY(Data * data, FluxMethod * fluxMethod) : ModelExtension(data), fluxMethod(fluxMethod)
{
  //  Syntax
  Data * d(this->data);
...
void DEIHY::sourceExtension(double * cons, double * prims, double * aux, double * source)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_vars(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_dwdsb(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_K(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_dfxdw(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_dfydw(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_dfzdw(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_Dx(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_Dy(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
...
void DEIHY::set_Dz(double * cons, double * prims, double * aux)
{
  // Syntax
  Data * d(this->data);
