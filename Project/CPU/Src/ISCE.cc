...
void ISCE::calcNSvars(double *cons, double *prims, double *aux) 
{
    ...
    for (int j(d->js_minus.at(0)); j < d->je_plus.at(0); j++) {
      for (int k(d->ks_minus.at(0)); k < d->ke_plus.at(0); k++) {
        ...
        */
        ...
        aux[ID(Aux::a1, i, j, k)] = aux[ID(Aux::W, i, j, k)] * ( aux[ID(Aux::W, i, j, k)]*aux[ID(Aux::dtv1, i, j, k)] 
          + prims[ID(Prims::v1, i, j, k)]*aux[ID(Aux::dtW, i, j, k)] + prims[ID(Prims::v1, i, j, k)]*dxux
          + prims[ID(Prims::v2, i, j, k)]*dyux + prims[ID(Prims::v3, i, j, k)]*dzux );
        
        aux[ID(Aux::a2, i, j, k)] = aux[ID(Aux::W, i, j, k)] * ( aux[ID(Aux::W, i, j, k)]*aux[ID(Aux::dtv2, i, j, k)] 
          + prims[ID(Prims::v2, i, j, k)]*aux[ID(Aux::dtW, i, j, k)] + prims[ID(Prims::v1, i, j, k)]*dxuy
          + prims[ID(Prims::v2, i, j, k)]*dyuy + prims[ID(Prims::v3, i, j, k)]*dzuy );
        
        aux[ID(Aux::a3, i, j, k)] = aux[ID(Aux::W, i, j, k)] * ( aux[ID(Aux::W, i, j, k)]*aux[ID(Aux::dtv3, i, j, k)] 
          + prims[ID(Prims::v3, i, j, k)]*aux[ID(Aux::dtW, i, j, k)] + prims[ID(Prims::v1, i, j, k)]*dxuz
        ...
        aux[ID(Aux::Theta, i, j, k)] = aux[ID(Aux::dtW, i, j, k)] + dxux + dyuy + dzuz;
        // Pi,NS = -zeta*Theta
