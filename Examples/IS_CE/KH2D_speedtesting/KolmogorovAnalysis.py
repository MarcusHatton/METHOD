...
if __name__ == "__main__":
    ...
    for n in range(n_files):
        fs.append(h5py.File(f'./2d/Shear/1em3_1em3/dp_400x800x0_{n}.hdf5', 'r'))
    ...
    with open('./pickles/KESpec_1em3_1em3_400x800.pickle', 'wb') as filehandle:
    ...
    plt.xlabel(r'$k$')
    plt.savefig('./KESpec_1em3_1em3_400x800.pdf')
    plt.close()
