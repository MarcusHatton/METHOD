...
int main(int argc, char *argv[]) {
  ...
  for(int i=0; i<nxs.size(); i++) {
    ...
    std::string dirpath = "../../../../../../scratch/mjh1n20/PureShear/SinWave/t_50/Shear/MIS/"+std::to_string(nx);
  ...
  const std::vector<double> toy_params           { {1.0e-15, 1.0e-12,  1.0e-15, 1.0e-12,  1.0e-3, 3.0e-2} };
