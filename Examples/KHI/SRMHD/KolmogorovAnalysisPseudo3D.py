...
if __name__ == "__main__":
    ...
    # Initialize KE spectra
    KE_Spec = 0

    # Select specific file to calculate spectra for
    f = fs[-1]
    ...
    with open('./pickles/KESpec_80x80x80_t=30_Ps3D.pickle', 'wb') as filehandle:
    ...
    plt.xlabel(r'$k$')
    plt.savefig('./plots/KESpec_80x80x80_t=30_Ps3D.pdf')
    plt.close()
